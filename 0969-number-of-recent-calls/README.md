<h2><a href="https://leetcode.com/problems/number-of-recent-calls">969. Number of Recent Calls</a></h2><p>You have a <code>RecentCounter</code> class which counts the number of recent requests within a certain time frame.</p>
